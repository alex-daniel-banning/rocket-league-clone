...
INSTANTIATE_TEST_SUITE_P(
    ...
    ::testing::Values(
        ...
        BoxBoxDetectionCase{.box_a_position = glm::vec3(0.0f),
                            ...
                            .box_b_rotation = engine::Math::GetRotationFromEulerAngles(glm::vec3(0.0f, 45.0f, 0.0f)),
                            .expect_collision = false,
        ...
        BoxBoxDetectionCase{.box_a_position = glm::vec3(0.0f),
                            .box_a_rotation = engine::Math::GetRotationFromEulerAngles(glm::vec3(0.0f, 45.0f, 0.0f)),
...
TEST_F(BoxBoxDetection, BoxesCollideDueToScale) {
  ...
  engine::physics::Box smaller_box(smaller_scale, glm::vec3(0.5f + std::sqrt(0.75f) + 0.001f, 0.0f, 0.0f),
                                   glm::vec3(0.0f), 1.0f, GetDiagonalAlignedOrientation({1, 0, 0}));
  engine::physics::Box larger_box(larger_scale, glm::vec3(0.5f + std::sqrt(0.75f) + 0.001f, 0.0f, 0.0f),
                                  glm::vec3(0.0f), 1.0f, GetDiagonalAlignedOrientation({1, 0, 0}));
