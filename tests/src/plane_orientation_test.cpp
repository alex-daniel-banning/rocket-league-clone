...
TEST(PlaneOrientation, PlaneRotation)
{
    ...
    // clang-format off
    test_util::ExpectVec3Near(p.getCornerPositions()[0], glm::vec3(-hx, hz, 0.0f)); 
    test_util::ExpectVec3Near(p.getCornerPositions()[1], glm::vec3( hx,  hz, 0.0f));
    test_util::ExpectVec3Near(p.getCornerPositions()[2], glm::vec3( hx, -hz, 0.0f));
    test_util::ExpectVec3Near(p.getCornerPositions()[3], glm::vec3(-hx, -hz, 0.0f));
    // clang-format on
}
...
TEST(PlaneOrientation, PlaneTranslation)
{
    ...
    engine::physics::Plane p(xsize, zsize, glm::vec3(0.5f), pos,
                             glm::angleAxis(degreesOfRotation, xAxis));
    // clang-format off
    test_util::ExpectVec3Near(p.getCornerPositions()[0], pos + glm::vec3(-hx, 0.0f,-hz)); 
    test_util::ExpectVec3Near(p.getCornerPositions()[1], pos + glm::vec3( hx, 0.0f,-hz));
    test_util::ExpectVec3Near(p.getCornerPositions()[2], pos + glm::vec3( hx, 0.0f, hz));
    test_util::ExpectVec3Near(p.getCornerPositions()[3], pos + glm::vec3(-hx, 0.0f, hz));
    // clang-format on
}
...
TEST(PlaneOrientation, PlaneRotationAndTranslation)
{
    ...
    engine::physics::Plane p(xsize, zsize, glm::vec3(0.5f), pos,
                             glm::angleAxis(degreesOfRotation, xAxis));
    // clang-format off
    test_util::ExpectVec3Near(p.getCornerPositions()[0], pos + glm::vec3(-hx, hz, 0.0f)); 
    test_util::ExpectVec3Near(p.getCornerPositions()[1], pos + glm::vec3( hx,  hz, 0.0f));
    test_util::ExpectVec3Near(p.getCornerPositions()[2], pos + glm::vec3( hx, -hz, 0.0f));
    test_util::ExpectVec3Near(p.getCornerPositions()[3], pos + glm::vec3(-hx, -hz, 0.0f));
    // clang-format on
}
