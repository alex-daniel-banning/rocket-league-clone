...
class Renderer
{
  public:
    ...
    void drawSphereWireframe(const engine::physics::Sphere &sphere, Shader &shader,
                             const Camera &camera);

    void drawModel(Model &model, Shader &shader, const Camera &camera, glm::vec3 position,
