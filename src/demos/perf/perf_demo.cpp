...
int main() {
  ...
  engine::Match match =
      engine::Match::Builder()
          ...
          .WithBox(engine::physics::BoxBuilder()
                       ...
                       .Mass(15.0f)
                       .Velocity(glm::vec3(4.0f, 3.0f, -2.0f))
                       .Build())
          .WithBox(engine::physics::BoxBuilder()
                       .Size(glm::vec3(2.0f))
  ...
  while (!glfwWindowShouldClose(window)) {
    ...
    glm::mat4 light_projection =
        glm::ortho(-room_size, room_size, -room_size, room_size, light_projection_near_plane,
    ...
    model_loading_shader.SetVec3("diffuseColor", glm::vec3(0.1f, 0.5f, 0.8f));
