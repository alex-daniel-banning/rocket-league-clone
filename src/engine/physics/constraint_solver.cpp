...
float ComputeJV(ContactConstraint cc) {
  ...
  // placeholders
  glm::vec3 v_a = glm::vec3(1.0f);
  glm::vec3 w_a = glm::vec3(1.0f);
  glm::vec3 v_b = glm::vec3(1.0f);
  glm::vec3 w_b = glm::vec3(1.0f);

  glm::vec3 j_v_a = glm::vec3(cc.jacobian[0], cc.jacobian[1], cc.jacobian[2]);
  glm::vec3 j_w_a = glm::vec3(cc.jacobian[3], cc.jacobian[4], cc.jacobian[5]);
  glm::vec3 j_v_b = glm::vec3(cc.jacobian[6], cc.jacobian[7], cc.jacobian[8]);
  glm::vec3 j_w_b = glm::vec3(cc.jacobian[9], cc.jacobian[10], cc.jacobian[11]);
